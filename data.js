/* --- Liar Entertainment Unified Data Ver.44.0 --- */
...
function openAlbumModal(groupId, index) {
    ...
    // 【最重要】ポップアップ表示後にiframeを生成
    let embedHtml = `<p style="padding:40px; text-align:center; font-weight:bold;">COMING SOON</p>`;
    if (a.embedUrl) {
        embedHtml = `<iframe src="${a.embedUrl}" frameborder="0" scrolling="no"></iframe>`;
    }
