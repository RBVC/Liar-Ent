/* --- Liar Entertainment Unified Data & Logic --- */
...
const allGroups = {
    "god7ike": {
        ...
        discography: [
            ...
            { title: "TEA", type: "4uatre Special Project / 2024.10.XX", img: "images/god7ike/4uatre-tea.jpg", embedUrl: "https://u.pcloud.link/publink/show?code=0ZQSjI5ZWGmPQhBKyQmOkHrDwTSGPpX65G27&view=list" },
    ...
    "hayul": {
        ...
        members: [], 
        discography: [
            { title: "神谕法则", type: "1st Digital Single / 2024.XX.XX", img: "images/hayul/hayul-the-law-of-god.jpg", embedUrl: "" }
        ],
    ...
    "v3": {
        ...
        about: "<3（V3、ヴィスリ）は、韓国の3人組バーチャルアイドルグループ。Liar Entertainment所属。グループ名は「ViVid Venom」の略称であり“鮮やかな音楽の毒で世界を魅了する”という意味を持つ。",
        members: [
            { name: "JIA (지아)", birthday: "2001.10.09", role: "Leader", position: "Main Vocal", img: "images/v3/v3-jia.jpg" },
            { name: "LICCA (릿카)", birthday: "2000.07.14", role: "Center", position: "Main Vocal / Main Rapper", img: "images/v3/v3-licca.jpg" },
            { name: "NAYEON (나연)", birthday: "2006.06.20", role: "Maknae", position: "Main Dancer", img: "images/v3/v3-nayeon.jpg" }
        ],
        discography: [
            { title: "COOL", type: "2nd Mini Album / 2022.10.31", img: "images/v3/v3-cool.jpg", embedUrl: "https://u.pcloud.link/publink/show?code=0ZeknS5ZhOGKkPxGKq5MjJAI6JVPLpTXBeRV&view=list" },
            { title: "VENOM", type: "1st Mini Album / 2022.04.10", img: "images/v3/v3-venom.jpg", embedUrl: "https://u.pcloud.link/publink/show?code=0Z8knS5ZA3xYWPiILQ0M3rQzVDNrM5a4Onw7&view=list" },
            { title: "ALL OUT", type: "Pre-Debut Cover EP / 2022.04.01", img: "images/v3/v3-allout.jpg", embedUrl: "https://u.pcloud.link/publink/show?code=0ZzzoU5ZgjQk2aTBTHF0ig70v7BxL0Y0ddGX&view=list" }
        ],
        hasMemberSection: true, clickableMembers: true
    }
};
...
function initCommonUI() {
    ...
    if (navUl) {
        navUl.innerHTML = Object.keys(allGroups).map(id => 
            `<li><a href="artist.html?id=${id}" onclick="toggleMenu()">${allGroups[id].name}</a></li>`
        ).join('');
    }
}
...
function openAlbumModal(groupId, index) {
    ...
    const embedHtml = a.embedUrl 
        ? `<iframe src="${a.embedUrl}" frameborder="0" scrolling="no"></iframe>`
        : `<p style="padding:40px; text-align:center; font-weight:bold;">COMING SOON</p>`;
    
    updateModal(a.title, `
        <p style="font-size:12px; color:#ccc; margin-bottom:20px; font-weight:900; text-align:center;">${a.type}</p>
        <div class="player-container">${embedHtml}</div>
    `);
}
